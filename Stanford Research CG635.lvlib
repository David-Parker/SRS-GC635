...
Synthesized Clock Generator 635 (CG635).</Property>
	...
	<Item Name="Public" Type="Folder">
		...
		<Item Name="Action-Status" Type="Folder">
			...
			<Item Name="Step Up or Down.vi" Type="VI" URL="Public/Action-Status/Step Up or Down.vi"/>
			<Item Name="Wait.vi" Type="VI" URL="Public/Action-Status/Wait.vi"/>
		</Item>
		<Item Name="Configure" Type="Folder">
			<Item Name="Low-level" Type="Folder">
				<Item Name="Configure CMOS.vi" Type="VI" URL="Public/Configure/Low-level/Configure CMOS.vi"/>
				<Item Name="Configure QQ.vi" Type="VI" URL="Public/Configure/Low-level/Configure QQ.vi"/>
			</Item>
			<Item Name="Configure.mnu" Type="Document" URL="/&lt;instrlib&gt;/Stanford Research CG635/Public/Configure/Configure.mnu"/>
			<Item Name="Configure Component Values.vi" Type="VI" URL="Public/Configure/Configure Component Values.vi"/>
			<Item Name="Configure Run and Stop States.vi" Type="VI" URL="Public/Configure/Configure Run and Stop States.vi"/>
			<Item Name="Configure Standard Outputs.vi" Type="VI" URL="Public/Configure/Configure Standard Outputs.vi"/>
			<Item Name="Enable PRBS.vi" Type="VI" URL="Public/Configure/Enable PRBS.vi"/>
		</Item>
